...
def plot_target_correctness(participant_means: pd.DataFrame) -> None:
    ...
    axes[1].set_ylabel("")
    axes[2].set_ylabel("")
    fig.suptitle("Phase 2 (Slides): Target correctness by boundary")
    fig.tight_layout()
...
def plot_rt(participant_means: pd.DataFrame) -> None:
    ...
    axes[1].set_ylabel("")
    axes[2].set_ylabel("")
    fig.suptitle("Phase 2 (Slides): Test RT by boundary")
    fig.tight_layout()
...
def plot_lure_bins(summary: pd.DataFrame) -> None:
    ...
    fig.suptitle("Phase 2 (Slides): Lure-bin descriptive summary")
    fig.tight_layout()
